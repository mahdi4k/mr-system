...
const CardPartPrice = ({ price, justify, isAds, tomanWidth, tomanHeight, textSize, mt, mb }: { mt?: StyleProp<MantineSpacing>, mb?: StyleProp<MantineSpacing>, price: string | undefined, justify?: string, isAds?: boolean, tomanWidth?: number, tomanHeight?: number, textSize?: any }) => {
    return (
        <>
            {price ? <>
                <Group justify={justify} gap={4} className={classes.Price} align='center' mt={mt ? mt : 'md'} mb={mb ? mb : 'xs'}>
