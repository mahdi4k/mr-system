      ...
      <Grid justify="center" py={"xl"}>
        ...
        >
          <Link style={{ textDecoration: "none" }} href={"/category/cpu"}>
            <Card
              ...
              bg={"var(--mantine-color-indigo-outline-hover)"}
              mih={"160px"}
              radius={"md"}
            >
            ...
            <Text className={classes.cardTitle} mt={"xs"}>
              cpu
            </Text>
          </Link>
        </Grid.Col>
        ...
        >
          ...
          >
            <Card
              className={classes.card}
              bg={"var(--mantine-color-cyan-outline-hover)"}
              mih={"160px"}
              radius={"md"}
            >
              <Flex justify={"center"} direction={"column"} align={"center"}>
        ...
        >
          <Link style={{ textDecoration: "none" }} href={"/category/power"}>
            <Card
              className={classes.card}
              bg={"var(--mantine-color-green-outline-hover)"}
              mih={"160px"}
              radius={"md"}
            >
              <Flex justify={"center"} direction={"column"} align={"center"}>
        ...
        >
          <Link style={{ textDecoration: "none" }} href={"/category/graphic"}>
            <Card
              className={classes.card}
              bg={"var(--mantine-color-violet-outline-hover)"}
              mih={"160px"}
              radius={"md"}
            >
              <Flex justify={"center"} direction={"column"} align={"center"}>
