...
import { IResult, CPU, Graphic, Motherboard, FAN, SSD, RAM, CASE, POWER } from '@/_redux/services';
...
const TotalPriceCalculator: React.FC<TotalPriceCalculatorProps> = ({ cpuData, graphicData, motherboardData, fanData, ssdData, ramData, caseData, powerData, setTotalPrice }) => {
    ...
    useEffect(() => {
        const newTotalPrice = [
            ...
            searchParams.has('motherboard') ? Number(motherboardData?.data?.price) : 0,
