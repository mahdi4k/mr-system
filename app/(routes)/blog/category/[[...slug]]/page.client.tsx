...
import { Card, Container, Grid, Text, Image, Group, Breadcrumbs, Anchor } from '@mantine/core'
import React from 'react'
import classes from './categoryCard.module.css'
import Link from 'next/link'
import { categoriesMO } from './page'

const PageClient = ({ posts, categories }: { posts: postsMO[], categories: categoriesMO[] }) => {
                ...
                <Grid>
                                    ...
                                    <Grid.Col mt={'xs'} span={{ base: 12 }}>
                                        <Link href={`/blog/${post.slug}`}>
                                            <Card withBorder radius="md" p={0} className={classes.card}>
                                                <Group className={classes.groupItem} wrap="nowrap" gap={0}>
                                                    ...
                                                    <div className={classes.body}>
                                                        <Text fw={'bolder'} className={classes.title} mt="xs" mb="md">
                                                            {post.title.rendered}
                                                        </Text>
                    ...
                    <Grid.Col visibleFrom='md' span={4}>
                        <Card withBorder className={classes.blogPostCategory}>
                            <Text pos={'relative'} className={classes.categoryTitle} fw={'bolder'}>دسته بندی‌ ها</Text>
