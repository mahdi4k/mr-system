...
type productType = {
  ...
  type: 'graphics' | 'powers' | 'motherboards' | 'cpus' | 'cases' | 'rams' | 'fans' | 'ssds'
}
...
const ComponentCase = dynamic(() => import('@/_components/single/CaseSingle'), { ssr: false })
const ComponentFan = dynamic(() => import('@/_components/single/FanSingle'), { ssr: false })
const ComponentRam = dynamic(() => import('@/_components/single/RamSingle'), { ssr: false })
const ComponentSsd = dynamic(() => import('@/_components/single/SsdSingle'), { ssr: false })
