...
const ImageUpload = ({onSubmit, currentImage, cropperRef, handlers, opened}: IProps) => {
            ...
            {opened ? (
                ...
                <div style={{position: 'relative'}}>
                    <Dropzone
                        ...
                        openRef={openRef}
                        onReject={(files) => dropZoneShowErrorMessage(files[0].errors[0].code)}
                        maxSize={1000000}
                    ...
                    <div onClick={() => openRef?.current?.()}
                         style={{position: 'absolute', left: '6px', bottom: 0, width: '22px', cursor: 'pointer'}}>
                        <IconEdit color={'gray'}/>
                    </div>
                </div>
            )}
