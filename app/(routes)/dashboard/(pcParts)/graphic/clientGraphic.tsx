...
import { useGetGraphicsQuery, useRemoveGraphicMutation } from '@/_redux/services/graphicApi';
...
const ClientGraphic = () => {
    ...
    const handleRemoveGraphic = () => {
        removeGraphic(selectedGraphicID)
        if (isSuccess) {
            notifications.show({
                color: 'green',
        ...
        <>
            <Stack>
                <Flex justify={'space-between'} align={'center'}>
                    <Text mt={"sm"} mb={"md"} fw={"bold"} fz={"lg"}>لیست graphic</Text>
                    <Link href="/dashboard/graphic/add">
                ...
                <Table>
                    <Table.Thead>
                        <Table.Tr>
                            ...
                            <Table.Th>مدل</Table.Th>
                            <Table.Th>psu</Table.Th>
                            <Table.Th></Table.Th>
                        </Table.Tr>
                    </Table.Thead>
