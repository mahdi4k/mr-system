...
const ClientPower = () => {
    ...
    const handleRemovePower = () => {
        removePower(selectedPowerID)
        if (isSuccess) {
            notifications.show({
                color: 'green',
        ...
        <>
            <Stack>
                <Flex justify={'space-between'} align={'center'}>
                    <Text mt={"sm"} mb={"md"} fw={"bold"} fz={"lg"}>لیست power</Text>
                    <Link href="/dashboard/power/add">
