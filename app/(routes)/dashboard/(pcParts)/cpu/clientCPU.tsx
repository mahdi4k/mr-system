...
import { useGetCpusQuery, useRemoveCpuMutation } from '@/_redux/services/cpuApi';
        ...
        <>
            <Stack>
                <Flex justify={'space-between'} align={'center'}>
                    <Text mt={"sm"} mb={"md"} fw={"bold"} fz={"lg"}>لیست cpu</Text>
