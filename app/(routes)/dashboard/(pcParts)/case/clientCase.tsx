...
import { useGetCasesQuery, useRemoveCaseMutation } from '@/_redux/services/caseApi';


const ClientCase = () => {
    const [loadingSession, setLoadingSession] = useState(false)
    const session = useSession()
    const { isSuccess, data = [], error } = useGetCasesQuery({}, { skip: !loadingSession })
        ...
        <>
            <Stack>
                <Flex justify={'space-between'} align={'center'}>
                    <Text mt={"sm"} mb={"md"} fw={"bold"} fz={"lg"}>لیست case</Text>
