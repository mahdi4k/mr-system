...
import { IconBook, IconDeviceDesktopAnalytics, IconGauge, IconHome2, TablerIconsProps } from "@tabler/icons-react";
...
const NavbarLinkMain: FC<props> = ({ active, setActive }) => {
    const mainLinks: Item[] = [
        ...
        { icon: IconBook, label: 'مقالات', value: 'articles', link: '/dashboard/articles' },
    ];
    return (
        <div>
            {mainLinks.map((link) => (
